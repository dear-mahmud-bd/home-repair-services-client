            ...
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow"> {navList} </ul>
                    </div>
                    <Link to="/" className="text-xl">
                        <img src={theme === 'light' ? darklogo : whitelogo} className='h-10' alt="Nav Logo" />
                    </Link>
                </div>
